"""Color-PDF detector entrypoint.

This wrapper intentionally locks the shared pipeline to ``detector_profile=color``.
Gray-only heuristics stay behind the gray engine.
"""
