...
from core.detector_scan_policy import (
    _cap_color_variant_peaks,
    _color_near_threshold_recovery_eligible,
    _compact_text_diagonal_roi_eligible,
    _gray_interrupted_label_recovery_eligible,
    _gray_near_threshold_recovery_eligible,
    _is_content_scan_eligible,
    _needs_directional_text_content_scan,
    _select_spatially_fair_peaks,
)
